...
fs.writeFileSync(
  path.resolve(
    __dirname,
    `../src/module/${moduleName}/controller/${moduleName}.controller.ts`
  ),
  controllerContent
);
...
fs.writeFileSync(
  path.resolve(
    __dirname,
    `../src/module/${moduleName}/service/${moduleName}.service.ts`
  ),
  serviceContent
);
...
fs.writeFileSync(
  path.resolve(
    __dirname,
    `../src/module/${moduleName}/entity/${moduleName}.entity.ts`
  ),
  entityContent
);

fs.writeFileSync(
  path.resolve(__dirname, `../src/module/${moduleName}/dto/${moduleName}.dto.ts`),
  dtoContent
);

fs.writeFileSync(
  path.resolve(__dirname, `../src/module/${moduleName}/vo/${moduleName}.vo.ts`),
  voContent
);
